...
export const TableWithProps = Table.extend({
  addAttributes() {
    return {
      ...
      tblWidth: {
        default: null,
        parseHTML: (el) => el.getAttribute('data-tbl-width'),
        renderHTML: (a) => (a.tblWidth ? { 'data-tbl-width': a.tblWidth, style: `width: ${a.tblWidth}` } : {}),
      },
      tblHeight: {
        default: null,
        parseHTML: (el) => el.getAttribute('data-tbl-height'),
        renderHTML: (a) => (a.tblHeight ? { 'data-tbl-height': a.tblHeight, style: `height: ${a.tblHeight}` } : {}),
      },
      tblAlign: {
        default: null,
        parseHTML: (el) => el.getAttribute('data-tbl-align'),
        renderHTML: (a) => {
      ...
      tblBorder: {
        default: null,
        parseHTML: (el) => el.getAttribute('data-tbl-border'),
        renderHTML: (a) => (a.tblBorder != null && a.tblBorder !== '' ? { 'data-tbl-border': String(a.tblBorder), style: `--cw-tbl-border: ${a.tblBorder}px` } : {}),
      },
      tblBorderColor: {
        default: null,
        parseHTML: (el) => el.getAttribute('data-tbl-border-color'),
        renderHTML: (a) => (a.tblBorderColor ? { 'data-tbl-border-color': a.tblBorderColor, style: `--cw-tbl-border-color: ${a.tblBorderColor}` } : {}),
      },
      tblBorderStyle: {
        default: null,
        parseHTML: (el) => el.getAttribute('data-tbl-border-style'),
        renderHTML: (a) => (a.tblBorderStyle ? { 'data-tbl-border-style': a.tblBorderStyle, style: `--cw-tbl-border-style: ${a.tblBorderStyle}` } : {}),
      },
      tblCellPad: {
        default: null,
        parseHTML: (el) => el.getAttribute('data-tbl-cellpad'),
        renderHTML: (a) => (a.tblCellPad != null && a.tblCellPad !== '' ? { 'data-tbl-cellpad': String(a.tblCellPad), style: `--cw-tbl-cellpad: ${a.tblCellPad}px` } : {}),
      },
      tblCellSpace: {
        default: null,
        parseHTML: (el) => el.getAttribute('data-tbl-cellspace'),
        renderHTML: (a) => (a.tblCellSpace != null && a.tblCellSpace !== '' ? { 'data-tbl-cellspace': String(a.tblCellSpace), style: `border-collapse: separate; border-spacing: ${a.tblCellSpace}px` } : {}),
      },
      tblBg: {
        default: null,
        parseHTML: (el) => el.getAttribute('data-tbl-bg'),
        renderHTML: (a) => (a.tblBg ? { 'data-tbl-bg': a.tblBg, style: `background-color: ${a.tblBg}` } : {}),
      },
    };
  },
